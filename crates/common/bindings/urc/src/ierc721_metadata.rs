...
pub mod IERC721Metadata {
	...
	impl alloy_sol_types::SolInterface for IERC721MetadataCalls {
		...
		fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
			static DECODE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<IERC721MetadataCalls>] = &[
				{
					fn supportsInterface(data: &[u8]) -> alloy_sol_types::Result<IERC721MetadataCalls> {
				...
				{
					fn name(data: &[u8]) -> alloy_sol_types::Result<IERC721MetadataCalls> {
						<nameCall as alloy_sol_types::SolCall>::abi_decode_raw(data).map(IERC721MetadataCalls::name)
					}
					name
				},
				{
					fn getApproved(data: &[u8]) -> alloy_sol_types::Result<IERC721MetadataCalls> {
				...
				{
					fn approve(data: &[u8]) -> alloy_sol_types::Result<IERC721MetadataCalls> {
				...
				{
					fn transferFrom(data: &[u8]) -> alloy_sol_types::Result<IERC721MetadataCalls> {
				...
				{
					fn safeTransferFrom_0(data: &[u8]) -> alloy_sol_types::Result<IERC721MetadataCalls> {
				...
				{
					fn ownerOf(data: &[u8]) -> alloy_sol_types::Result<IERC721MetadataCalls> {
				...
				{
					fn balanceOf(data: &[u8]) -> alloy_sol_types::Result<IERC721MetadataCalls> {
				...
				{
					fn symbol(data: &[u8]) -> alloy_sol_types::Result<IERC721MetadataCalls> {
						<symbolCall as alloy_sol_types::SolCall>::abi_decode_raw(data).map(IERC721MetadataCalls::symbol)
					}
					symbol
				},
				{
					fn setApprovalForAll(data: &[u8]) -> alloy_sol_types::Result<IERC721MetadataCalls> {
				...
				{
					fn safeTransferFrom_1(data: &[u8]) -> alloy_sol_types::Result<IERC721MetadataCalls> {
				...
				{
					fn tokenURI(data: &[u8]) -> alloy_sol_types::Result<IERC721MetadataCalls> {
				...
				{
					fn isApprovedForAll(data: &[u8]) -> alloy_sol_types::Result<IERC721MetadataCalls> {
		...
		fn abi_decode_raw_validate(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
			static DECODE_VALIDATE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<IERC721MetadataCalls>] = &[
				{
					fn supportsInterface(data: &[u8]) -> alloy_sol_types::Result<IERC721MetadataCalls> {
