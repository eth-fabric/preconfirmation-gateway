...
pub mod IERC721TokenReceiver {
		...
		impl alloy_sol_types::SolCall for onERC721ReceivedCall {
			...
			fn tokenize(&self) -> Self::Token<'_> {
				(
					...
					<alloy::sol_types::sol_data::Bytes as alloy_sol_types::SolType>::tokenize(&self._data),
				)
			}
			#[inline]
			fn tokenize_returns(ret: &Self::Return) -> Self::ReturnToken<'_> {
				(<alloy::sol_types::sol_data::FixedBytes<4> as alloy_sol_types::SolType>::tokenize(ret),)
			}
			#[inline]
	...
	impl alloy_sol_types::SolInterface for IERC721TokenReceiverCalls {
		...
		fn selector(&self) -> [u8; 4] {
			match self {
				Self::onERC721Received(_) => <onERC721ReceivedCall as alloy_sol_types::SolCall>::SELECTOR,
			}
		}
		#[inline]
		...
		fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
			static DECODE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<IERC721TokenReceiverCalls>] = &[{
				fn onERC721Received(data: &[u8]) -> alloy_sol_types::Result<IERC721TokenReceiverCalls> {
		...
		fn abi_decode_raw_validate(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
			static DECODE_VALIDATE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<IERC721TokenReceiverCalls>] = &[{
				fn onERC721Received(data: &[u8]) -> alloy_sol_types::Result<IERC721TokenReceiverCalls> {
					<onERC721ReceivedCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(data)
						.map(IERC721TokenReceiverCalls::onERC721Received)
				}
				onERC721Received
			}];
