...
pub mod IERC165 {
	...
	impl IERC165Calls {
		...
		pub const VARIANT_NAMES: &'static [&'static str] = &[::core::stringify!(supportsInterface)];
	...
	impl<P: alloy_contract::private::Provider<N>, N: alloy_contract::private::Network> IERC165Instance<P, N> {
		/**Creates a new wrapper around an on-chain [`IERC165`](self) contract instance.
		...
		For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
		#[inline]
		pub async fn deploy(__provider: P) -> alloy_contract::Result<IERC165Instance<P, N>> {
