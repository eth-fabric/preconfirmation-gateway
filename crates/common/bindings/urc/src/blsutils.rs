...
```*/
    ...
    const _: () = {
        ...
        }
        {
            ...
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<_toLittleEndianReturn>
        ...
        impl alloy_sol_types::SolCall for _toLittleEndianCall {
            ...
            type Token<'a> = <Self::Parameters<
                'a,
            > as alloy_sol_types::SolType>::Token<'a>;
            type Return = _toLittleEndianReturn;
...
```*/
        ...
        impl alloy_sol_types::SolCall for verifyCall {
            ...
            fn tokenize(&self) -> Self::Token<'_> {
                (
                    ...
                    <BLS::G1Point as alloy_sol_types::SolType>::tokenize(
                        &self.publicKey,
                    ),
                    <alloy::sol_types::sol_data::FixedBytes<
                        32,
    ...
    impl BLSUtilsCalls {
        ...
        pub const SELECTORS: &'static [[u8; 4usize]] = &[
            [94u8, 234u8, 120u8, 125u8],
            [191u8, 71u8, 66u8, 166u8],
        ];
    }
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for BLSUtilsCalls {
        ...
        fn selector(&self) -> [u8; 4] {
            match self {
                Self::_toLittleEndian(_) => {
                    <_toLittleEndianCall as alloy_sol_types::SolCall>::SELECTOR
                }
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<BLSUtilsCalls>] = &[
                {
                    fn _toLittleEndian(
                        data: &[u8],
                        validate: bool,
                    ) -> alloy_sol_types::Result<BLSUtilsCalls> {
                        <_toLittleEndianCall as alloy_sol_types::SolCall>::abi_decode_raw(
                                data,
                                validate,
                            )
        ...
        fn abi_encoded_size(&self) -> usize {
            match self {
                Self::_toLittleEndian(inner) => {
                    <_toLittleEndianCall as alloy_sol_types::SolCall>::abi_encoded_size(
                        inner,
                    )
                }
                Self::verify(inner) => {
        ...
        fn abi_encode_raw(&self, out: &mut alloy_sol_types::private::Vec<u8>) {
            match self {
                Self::_toLittleEndian(inner) => {
                    <_toLittleEndianCall as alloy_sol_types::SolCall>::abi_encode_raw(
                        inner,
                        out,
                    )
                }
...
See the [wrapper's documentation](`BLSUtilsInstance`) for more details.*/
    ...
    >(
        address: alloy_sol_types::private::Address,
        provider: P,
    ) -> BLSUtilsInstance<T, P, N> {
        BLSUtilsInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<BLSUtilsInstance<T, P, N>>,
    > {
        BLSUtilsInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        BLSUtilsInstance::<T, P, N>::deploy_builder(provider)
    }
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct BLSUtilsInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for BLSUtilsInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<BLSUtilsInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> BLSUtilsInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> BLSUtilsInstance<T, P, N> {
            BLSUtilsInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network_transport: ::core::marker::PhantomData,
    ...
    > BLSUtilsInstance<T, P, N> {
        ...
        pub fn _toLittleEndian(
            &self,
            x: u64,
        ) -> alloy_contract::SolCallBuilder<T, &P, _toLittleEndianCall, N> {
