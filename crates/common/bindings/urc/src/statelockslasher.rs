    ...
    impl alloy_sol_types::SolInterface for StateLockSlasherCalls {
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<StateLockSlasherCalls>] = &[
                {
                    fn _getCurrentSlot(
                        data: &[u8],
                        validate: bool,
    ...
    impl alloy_sol_types::SolInterface for StateLockSlasherErrors {
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<StateLockSlasherErrors>] = &[
                {
...
See the [wrapper's documentation](`StateLockSlasherInstance`) for more details.*/
    ...
    >(
        address: alloy_sol_types::private::Address,
        provider: P,
    ) -> StateLockSlasherInstance<T, P, N> {
        StateLockSlasherInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<StateLockSlasherInstance<T, P, N>>,
    > {
        StateLockSlasherInstance::<T, P, N>::deploy(provider, _slashAmountWei)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(
        ...
        StateLockSlasherInstance::<T, P, N>::deploy_builder(provider, _slashAmountWei)
    }
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct StateLockSlasherInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for StateLockSlasherInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
            _slashAmountWei: alloy::sol_types::private::primitives::aliases::U256,
        ) -> alloy_contract::Result<StateLockSlasherInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
            ...
            alloy_contract::RawCallBuilder::new_raw_deploy(
                ...
                [
                    ...
                    &alloy_sol_types::SolConstructor::abi_encode(
                        &constructorCall { _slashAmountWei },
                    )[..],
                ]
                    .concat()
                    .into(),
    ...
    impl<T, P: ::core::clone::Clone, N> StateLockSlasherInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> StateLockSlasherInstance<T, P, N> {
