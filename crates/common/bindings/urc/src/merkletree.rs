...
```*/
    ...
    impl MerkleTreeErrors {
        ...
        pub const SELECTORS: &'static [[u8; 4usize]] = &[
            [6u8, 202u8, 14u8, 179u8],
            [78u8, 35u8, 208u8, 53u8],
            [208u8, 165u8, 35u8, 184u8],
        ];
    }
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for MerkleTreeErrors {
        ...
        fn selector(&self) -> [u8; 4] {
            match self {
                Self::EmptyLeaves(_) => {
                    <EmptyLeaves as alloy_sol_types::SolError>::SELECTOR
                }
                Self::IndexOutOfBounds(_) => {
                    <IndexOutOfBounds as alloy_sol_types::SolError>::SELECTOR
                }
                Self::LeavesTooLarge(_) => {
                    <LeavesTooLarge as alloy_sol_types::SolError>::SELECTOR
                }
            }
        }
        #[inline]
            ...
            static DECODE_SHIMS: &[fn(
            ...
            ) -> alloy_sol_types::Result<MerkleTreeErrors>] = &[
                {
                    fn LeavesTooLarge(
                        ...
                        <LeavesTooLarge as alloy_sol_types::SolError>::abi_decode_raw(
                                data,
                                validate,
                            )
                ...
                },
                {
                    fn EmptyLeaves(
                        ...
                        <EmptyLeaves as alloy_sol_types::SolError>::abi_decode_raw(
                                data,
                                validate,
                            )
        ...
        fn abi_encoded_size(&self) -> usize {
            match self {
                Self::EmptyLeaves(inner) => {
                    <EmptyLeaves as alloy_sol_types::SolError>::abi_encoded_size(inner)
                }
                ...
                Self::LeavesTooLarge(inner) => {
                    <LeavesTooLarge as alloy_sol_types::SolError>::abi_encoded_size(
                        inner,
                    )
                }
            }
        ...
        fn abi_encode_raw(&self, out: &mut alloy_sol_types::private::Vec<u8>) {
            match self {
                Self::EmptyLeaves(inner) => {
                    <EmptyLeaves as alloy_sol_types::SolError>::abi_encode_raw(
                        inner,
                        out,
                    )
                }
                ...
                Self::LeavesTooLarge(inner) => {
                    <LeavesTooLarge as alloy_sol_types::SolError>::abi_encode_raw(
                        inner,
                        out,
                    )
                }
