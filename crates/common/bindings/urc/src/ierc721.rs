...
pub mod IERC721 {
	...
	impl alloy_sol_types::SolInterface for IERC721Calls {
		...
		fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
			static DECODE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<IERC721Calls>] = &[
				{
					fn supportsInterface(data: &[u8]) -> alloy_sol_types::Result<IERC721Calls> {
				...
				{
					fn getApproved(data: &[u8]) -> alloy_sol_types::Result<IERC721Calls> {
				...
				},
				{
					fn approve(data: &[u8]) -> alloy_sol_types::Result<IERC721Calls> {
						<approveCall as alloy_sol_types::SolCall>::abi_decode_raw(data).map(IERC721Calls::approve)
					}
					approve
				},
				{
					fn transferFrom(data: &[u8]) -> alloy_sol_types::Result<IERC721Calls> {
				...
				{
					fn safeTransferFrom_0(data: &[u8]) -> alloy_sol_types::Result<IERC721Calls> {
				...
				},
				{
					fn ownerOf(data: &[u8]) -> alloy_sol_types::Result<IERC721Calls> {
						<ownerOfCall as alloy_sol_types::SolCall>::abi_decode_raw(data).map(IERC721Calls::ownerOf)
					}
					ownerOf
				},
				{
					fn balanceOf(data: &[u8]) -> alloy_sol_types::Result<IERC721Calls> {
						<balanceOfCall as alloy_sol_types::SolCall>::abi_decode_raw(data).map(IERC721Calls::balanceOf)
					}
					balanceOf
				},
				{
					fn setApprovalForAll(data: &[u8]) -> alloy_sol_types::Result<IERC721Calls> {
				...
				{
					fn safeTransferFrom_1(data: &[u8]) -> alloy_sol_types::Result<IERC721Calls> {
				...
				{
					fn isApprovedForAll(data: &[u8]) -> alloy_sol_types::Result<IERC721Calls> {
		...
		fn abi_decode_raw_validate(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
			static DECODE_VALIDATE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<IERC721Calls>] = &[
				{
					fn supportsInterface(data: &[u8]) -> alloy_sol_types::Result<IERC721Calls> {
	...
	pub fn deploy<P: alloy_contract::private::Provider<N>, N: alloy_contract::private::Network>(
		__provider: P,
	) -> impl ::core::future::Future<Output = alloy_contract::Result<IERC721Instance<P, N>>> {
	...
	impl<P: alloy_contract::private::Provider<N>, N: alloy_contract::private::Network> IERC721Instance<P, N> {
		/**Creates a new wrapper around an on-chain [`IERC721`](self) contract instance.
		...
		For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
		#[inline]
		pub async fn deploy(__provider: P) -> alloy_contract::Result<IERC721Instance<P, N>> {
