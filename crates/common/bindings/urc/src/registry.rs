...
```*/
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolEvent for OperatorSlashed {
            ...
            fn tokenize_body(&self) -> Self::DataToken<'_> {
                (
                    <IRegistry::SlashingType as alloy_sol_types::SolType>::tokenize(
                        &self.slashingType,
                    ),
                    <alloy::sol_types::sol_data::Address as alloy_sol_types::SolType>::tokenize(
                        &self.owner,
...
```*/
    ...
    const _: () = {
        use alloy::sol_types as alloy_sol_types;
        {
            ...
            #[doc(hidden)]
            type UnderlyingRustTuple<'a> = (
                <IRegistry::Config as alloy::sol_types::SolType>::RustType,
            );
            #[cfg(test)]
            #[allow(dead_code, unreachable_patterns)]
            fn _type_assertion(
        ...
        impl alloy_sol_types::SolConstructor for constructorCall {
            ...
            fn tokenize(&self) -> Self::Token<'_> {
                (
                    <IRegistry::Config as alloy_sol_types::SolType>::tokenize(
                        &self._config,
                    ),
                )
            }
...
```*/
    ...
    const _: () = {
        ...
        }
        {
            ...
            #[doc(hidden)]
            type UnderlyingRustTuple<'a> = (
                <IRegistry::OperatorData as alloy::sol_types::SolType>::RustType,
            );
            #[cfg(test)]
            #[allow(dead_code, unreachable_patterns)]
            fn _type_assertion(
...
```*/
    ...
    const _: () = {
        ...
        }
        {
            ...
            #[doc(hidden)]
            type UnderlyingRustTuple<'a> = (
                <IRegistry::SlasherCommitment as alloy::sol_types::SolType>::RustType,
            );
            #[cfg(test)]
            #[allow(dead_code, unreachable_patterns)]
            fn _type_assertion(
...
```*/
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolCall for getVerifiedOperatorDataCall {
            ...
            fn tokenize(&self) -> Self::Token<'_> {
                (
                    <IRegistry::RegistrationProof as alloy_sol_types::SolType>::tokenize(
                        &self.proof,
                    ),
                )
            }
    ...
    impl alloy_sol_types::SolInterface for RegistryCalls {
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<RegistryCalls>] = &[
                {
                    fn unregister(
                        data: &[u8],
                        validate: bool,
    ...
    impl alloy_sol_types::SolInterface for RegistryErrors {
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<RegistryErrors>] = &[
                {
                    fn InvalidProof(
                        data: &[u8],
                        validate: bool,
...
See the [wrapper's documentation](`RegistryInstance`) for more details.*/
    ...
    >(
        address: alloy_sol_types::private::Address,
        provider: P,
    ) -> RegistryInstance<T, P, N> {
        RegistryInstance::<T, P, N>::new(address, provider)
    }
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct RegistryInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for RegistryInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
...
See the [wrapper's documentation](`RegistryInstance`) for more details.*/
    ...
    impl<T, P: ::core::clone::Clone, N> RegistryInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> RegistryInstance<T, P, N> {
            RegistryInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network_transport: ::core::marker::PhantomData,
