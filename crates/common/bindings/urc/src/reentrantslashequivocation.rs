    ...
    impl alloy_sol_types::SolInterface for ReentrantSlashEquivocationCalls {
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<ReentrantSlashEquivocationCalls>] = &[
                {
                    fn register(
                        data: &[u8],
                        validate: bool,
...
See the [wrapper's documentation](`ReentrantSlashEquivocationInstance`) for more details.*/
    ...
    >(
        address: alloy_sol_types::private::Address,
        provider: P,
    ) -> ReentrantSlashEquivocationInstance<T, P, N> {
        ReentrantSlashEquivocationInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<ReentrantSlashEquivocationInstance<T, P, N>>,
    > {
        ReentrantSlashEquivocationInstance::<T, P, N>::deploy(provider, registryAddress)
    }
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct ReentrantSlashEquivocationInstance<
        T,
        P,
    ...
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for ReentrantSlashEquivocationInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("ReentrantSlashEquivocationInstance")
                .field(&self.address)
                .finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
            registryAddress: alloy::sol_types::private::Address,
        ) -> alloy_contract::Result<ReentrantSlashEquivocationInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> ReentrantSlashEquivocationInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
