...
pub mod IERC20 {
	...
	const _: () = {
		...
		impl alloy_sol_types::SolCall for balanceOfCall {
			...
			#[inline]
			fn tokenize(&self) -> Self::Token<'_> {
				(<alloy::sol_types::sol_data::Address as alloy_sol_types::SolType>::tokenize(&self.account),)
			}
			#[inline]
			fn tokenize_returns(ret: &Self::Return) -> Self::ReturnToken<'_> {
				(<alloy::sol_types::sol_data::Uint<256> as alloy_sol_types::SolType>::tokenize(ret),)
	...
	impl alloy_sol_types::SolInterface for IERC20Calls {
			...
			static DECODE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<IERC20Calls>] = &[
				{
					fn name(data: &[u8]) -> alloy_sol_types::Result<IERC20Calls> {
						<nameCall as alloy_sol_types::SolCall>::abi_decode_raw(data).map(IERC20Calls::name)
					}
					name
				},
				{
					fn approve(data: &[u8]) -> alloy_sol_types::Result<IERC20Calls> {
						<approveCall as alloy_sol_types::SolCall>::abi_decode_raw(data).map(IERC20Calls::approve)
					}
					approve
				},
				{
				...
				},
				{
					fn decimals(data: &[u8]) -> alloy_sol_types::Result<IERC20Calls> {
						<decimalsCall as alloy_sol_types::SolCall>::abi_decode_raw(data).map(IERC20Calls::decimals)
					}
					decimals
				},
				{
					fn balanceOf(data: &[u8]) -> alloy_sol_types::Result<IERC20Calls> {
						<balanceOfCall as alloy_sol_types::SolCall>::abi_decode_raw(data).map(IERC20Calls::balanceOf)
					}
					balanceOf
				},
				{
					fn symbol(data: &[u8]) -> alloy_sol_types::Result<IERC20Calls> {
						<symbolCall as alloy_sol_types::SolCall>::abi_decode_raw(data).map(IERC20Calls::symbol)
					}
					symbol
				},
				{
					fn transfer(data: &[u8]) -> alloy_sol_types::Result<IERC20Calls> {
						<transferCall as alloy_sol_types::SolCall>::abi_decode_raw(data).map(IERC20Calls::transfer)
					}
					transfer
				},
				{
					fn allowance(data: &[u8]) -> alloy_sol_types::Result<IERC20Calls> {
						<allowanceCall as alloy_sol_types::SolCall>::abi_decode_raw(data).map(IERC20Calls::allowance)
					}
					allowance
				},
			];
		...
		fn abi_decode_raw_validate(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
			static DECODE_VALIDATE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<IERC20Calls>] = &[
				{
					fn name(data: &[u8]) -> alloy_sol_types::Result<IERC20Calls> {
						<nameCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(data).map(IERC20Calls::name)
					}
					name
				},
				{
				...
				{
					fn symbol(data: &[u8]) -> alloy_sol_types::Result<IERC20Calls> {
						<symbolCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(data).map(IERC20Calls::symbol)
					}
					symbol
				},
				{
